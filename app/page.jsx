    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600 text-lg">
            We make gift-giving extraordinary
          </p>
        </motion.div>
  ...
  const testimonials = [
    {
      ...
      quote:
        "The most beautiful gifts I've ever received! The packaging was absolutely stunning.",
      rating: 5,
    },
    {
      name: "Michael Chen",
      ...
      quote:
        "Fast delivery and amazing quality. My wife loved her anniversary gift!",
      rating: 5,
    },
    {
      name: "Emily Davis",
      ...
      quote:
        "The personalized touch made all the difference. Highly recommend Gift Gallery!",
      rating: 5,
    },
  ];
    ...
    <section className="py-20 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600 text-lg">
            This week's featured premium selection
          </p>
        </motion.div>
          ...
          >
            <div className="bg-gradient-to-br from-pink-50 to-purple-50 p-8 rounded-2xl">
              ...
              <p className="text-gray-600 text-lg mb-6">
                Indulge in pure relaxation with our premium spa gift set.
                Includes organic bath salts, essential oils, silk eye mask, and
                handcrafted soaps in an elegant wooden box.
              </p>
